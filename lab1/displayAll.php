...
function getRecords()
{
    ...
    $sql = "SELECT * from assets 
            ...
            WHERE assets.condition IS NULL ";
        ...
        <nav class="navbar navbar-inverse">
          <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
              <li class="active"><a href="displayAll.php"id="currentpage">Main Page</a></li>
